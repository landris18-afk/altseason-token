...
const TermsModal = ({ 
  ...
  return (
    <>
      {/* Mobile: Full screen */}
      <div className="md:hidden fixed inset-0 bg-gray-900 z-[9999]">
      ...
      {/* Desktop: Popup modal */}
      <div className="hidden md:flex fixed inset-0 bg-black/80 backdrop-blur-sm items-center justify-center z-[9999] p-4">
